    ...
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          ...
          z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md p-1 shadow-md`,
          className
        )}
        {...props}
      />
...
function MenubarSeparator({
  ...
  return (
    <MenubarPrimitive.Separator
      ...
      className={cn("bg-[var(--window-text-color)] -mx-1 my-1 h-[0.5px]", className)}
      {...props}
    />
  )
}
