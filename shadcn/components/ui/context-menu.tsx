  ...
  return (
    <ContextMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        z-50 min-w-[8rem] origin-(--radix-context-menu-content-transform-origin) overflow-hidden rounded-md p-1 shadow-lg`,
        className
      )}
      {...props}
    />
    ...
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          ...
          data-[side=right]:slide-in-from-left-2
          data-[side=top]:slide-in-from-bottom-2
          z-50 max-h-(--radix-context-menu-content-available-height) min-w-[8rem] origin-(--radix-context-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md p-1 shadow-md`,
          className
        )}
        {...props}
      />
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "text-primary px-2 py-1.5 text-sm font-bold data-[inset]:pl-8",
        className
      )}
      {...props}
    />
...
function ContextMenuSeparator({
  ...
  return (
    <ContextMenuPrimitive.Separator
      ...
      className={cn("bg-foreground -mx-1 my-1 h-[0.5px]", className)}
      {...props}
    />
  )
}
